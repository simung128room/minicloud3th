    ...
    <div className="min-h-[85vh] flex flex-col items-center justify-center p-4 md:p-8 font-sans">
      ...
      >
        <div className="flex justify-between items-center mb-8">
          <button 
            onClick={onBack}
            className="flex items-center gap-2 text-muted-foreground hover:text-white transition-all group font-bold px-4 py-2.5 bg-card border border-border border-2 brut-card rounded-xl"
          >
          ...
          <div className="flex items-center gap-2 px-4 py-2.5 bg-primary/20 text-primary-foreground border border-border border-2 rounded-full">
            <Sparkles className="w-4 h-4 text-blue-600" />
            <span className="text-blue-600 text-[10px] font-black uppercase tracking-[0.2em]">Key Activation</span>
          </div>
        </div>

        <div className="bg-card border border-border border-2 overflow-hidden brut-card rounded-3xl">
          <div className="grid grid-cols-1 lg:grid-cols-12 relative z-10">
            
            {/* Left Column: Info & Benefits */}
            <div className="lg:col-span-12 xl:col-span-5 p-8 md:p-12 border-b lg:border-b-0 lg:border-r border-border border-2 bg-card relative overflow-hidden brut-card rounded-2xl">
              ...
              <div className="pt-6 border-t border-border border-2 relative z-10">
                ...
                <button 
                  onClick={onGoToStore}
                  className="w-full flex items-center justify-between px-5 py-4 bg-card hover:bg-[#050505] text-white transition-all active:scale-[0.98] group brut-card rounded-xl"
                >
            ...
            <div className="lg:col-span-12 xl:col-span-7 p-8 md:p-12 lg:p-16 flex flex-col justify-center bg-card relative brut-card rounded-2xl">
              <div className="max-w-md mx-auto w-full relative z-10">
                <div className="mb-10">
                   <div className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-card border border-border border-2 text-[10px] font-bold uppercase tracking-widest text-muted-foreground mb-4 brut-card rounded-md">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    ...
                    {!isLoggedIn && (
                      <div className="mt-3 text-center">
                        ...
                        <button type="button" onClick={onLoginClick} className="px-4 py-2 bg-primary text-primary-foreground text-blue-600 text-sm font-bold hover:bg-purple-600/20 transition-colors rounded-xl">เข้าสู่ระบบ / สมัครสมาชิก</button>
                      </div>
                    )}
                  </div>
                  ...
                  <button 
                    ...
                    className="w-full relative group h-16 disabled:opacity-50 disabled:cursor-not-allowed transition-all rounded-xl"
                  >
