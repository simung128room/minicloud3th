  ...
  return (
    <div className="w-full animate-in fade-in duration-500 max-w-4xl mx-auto py-8">
      <div className="flex items-center gap-2 mb-8 text-sm">
        <button onClick={onBack} className="text-muted-foreground hover:text-white transition-colors flex items-center gap-1 font-bold rounded-xl">
      ...
      <motion.div 
        ...
        className="bg-card border border-border border-2 overflow-hidden p-8 md:p-12 min-h-[60vh] brut-card rounded-2xl"
      >
